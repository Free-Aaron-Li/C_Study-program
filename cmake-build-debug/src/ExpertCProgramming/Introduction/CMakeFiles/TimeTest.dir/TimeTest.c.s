...
.Ltext0:
	.section	.rodata
.LC0:
	.string	"the biggest time = %s\n"
.LC1:
	.string	"really the biggest time = %s\n"
	.text
	.globl	main
	.type	main, @function
main:
.LFB0:
	.file 1 "/home/AaronLi/C_Workspace/src/ExpertCProgramming/Introduction/TimeTest.c"
	.loc 1 12 1
	.cfi_startproc
	pushq	%rbp
...
.LASF48:
	.string	"sys_nerr"
.LASF58:
	.string	"/home/AaronLi/C_Workspace/src/ExpertCProgramming/Introduction/TimeTest.c"
.LASF5:
	.string	"short int"
.LASF7:
	.string	"size_t"
