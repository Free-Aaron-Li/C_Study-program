# 1 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c"
...
# 9 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c" 2
...
# 16 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c"
int main() {
    int c, i, nc, state;
    int len;
    int maxValue;
    ...
    for (i = 0; i < 11; ++i)
        wl[i] = 0;
    while ((c = getchar()) != 
# 28 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c" 3 4
                             (-1)
# 28 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c"
                                ) {
        if (c == ' ' || c == '\n' || c == '\t') {
            state=0;
            if(nc>0){
