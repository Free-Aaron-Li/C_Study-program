...
.LC0:
	.string	"%5d -%5d : "
.LC1:
	.string	"There are %d words >= %d\n"
	.text
	.globl	main
	.type	main, @function
main:
.LFB0:
	.file 1 "/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c"
	.loc 1 16 12
	.cfi_startproc
	pushq	%rbp
	...
	jmp	.L2
.L3:
	.loc 1 27 15 discriminator 3
	movl	-4(%rbp), %eax
	cltq
	movl	$0, -80(%rbp,%rax,4)
	.loc 1 26 25 discriminator 3
	addl	$1, -4(%rbp)
.L2:
...
.L18:
	...
	cmpl	$0, -16(%rbp)
	jg	.L19
	.loc 1 60 9 discriminator 2
	movl	$10, %edi
	call	putchar
	.loc 1 49 25 discriminator 2
	addl	$1, -4(%rbp)
.L14:
...
.LASF36:
	.string	"_freeres_buf"
.LASF53:
	.string	"/home/AaronLi/C_Workspace/ChapterOneIntroduction/exercise/1-13-WordHistogram.c"
.LASF46:
	.string	"stderr"
.LASF31:
	.string	"_lock"
